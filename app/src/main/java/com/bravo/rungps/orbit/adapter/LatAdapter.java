package com.bravo.rungps.orbit.adapter;
...
public class LatAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView) convertView).setText("距离 ：" + getDoubleToStr(item.distance)+"m " + ",  速度 ："
                + getDoubleToStr(item.velocity) +"m/s"+ ",  用时 ： " + item.preGapTime/1000+ "分" + ",  GpsSpeed : "
