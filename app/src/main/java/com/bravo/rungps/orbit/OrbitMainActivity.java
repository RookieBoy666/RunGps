...
public class OrbitMainActivity extends BaseMVPActivity<MainActView, MainActPresenter> implements View.OnClickListener, MainActView, Observer {
    ...
    private void getCurrentLocation() {
        ...
        rxPermissions.request(Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION)
                .subscribe(granted -> {
                    if (granted) {
                        //有权限了。
                        startService(new Intent(OrbitMainActivity.this, WorkService.class));
                    } else {
                        //没有权限。
                        showToast("没有权限");
                    }
