...
import com.bravo.rungps.run.StepCounterService;
import com.bravo.rungps.run.StepDetector;
...
public class StepCounterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.run);  //设置当前屏幕
	...
	private void init() {
		...
		weight = SettingsActivity.sharedPreferences.getInt(
				SettingsActivity.WEIGHT_VALUE, 60);
