...
public class CustomRelativeLayout extends RelativeLayout {
    ...
    private MyInterface.FinishActivityListener finishActivityListener;
    private int downX;

    public void setFinishActivityListener(MyInterface.FinishActivityListener finishActivityListener) {
